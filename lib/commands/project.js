 ...
 */
//-----------------------------------------------------------------------------
project.deploy = function(projectName, dir, projectType, includeModules, nodeVersion, forceNpmInstall, cb) {
  ...
  projectController.find({
    ...
    function(err, projects) {
      ...
      project.chooseProjectPrompt(projects, projectName, function(err, result) {
        ...
        projectController.deploy(result.id, dir, projectType, includeModules, nodeVersion, forceNpmInstall, function(err, domain) {
          if(!err) {
