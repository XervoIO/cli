 ...
 */
//-----------------------------------------------------------------------------
project.deploy = function(projectName, dir, includeModules, nodeVersion, cb) {
  ...
  projectController.find({
    ...
    function(err, projects) {
      ...
      project.chooseProjectPrompt(projects, projectName, function(err, result) {
        ...
        projectController.deploy(result.id, dir, includeModules, nodeVersion, function(err, domain) {
          if(!err) {
