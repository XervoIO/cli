...
user.signup = function(cb) {
  xervo.io.print('In order to sign up we a few pieces of information.');
  _signupPrompt(cb);
};
...
var _signupPrompt = function(cb) {
  xervo.io.prompt.get([{
      ...
      if(result.password !== result.passwordConfirm) {
        xervo.io.error('Passwords much match.');
      ...
      userController.create(
        ...
        function(err, u) {
          ...
          xervo.io.success('User ' + result.username.data + ' has been created successfully.');
          xervo.io.print('You should receive an email at ' + result.email.data + ' with more information.');
