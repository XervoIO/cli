...
//-----------------------------------------------------------------------------
AddOn.prototype.provision = function(projectId, addOnId, plan, callback) {
  librarian.addOns.provision(userConfig.data.userId, addOnId, plan, projectId, {}, userConfig.data.apiKey, function(err, addon) {
    if(err) {
      return callback(Errors.getMessage(err));
    }
