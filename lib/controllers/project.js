var modulus = require('../modulus'),
    ...
    scribe = require('../common/api').scribe,
...
Project.prototype.downloadLogs = function(projectId, projectName, outLocation, callback) {
  scribe.project.downloadLogs(projectId, userConfig.data.apiKey, function(err, req, res){
    if(err){
...
Project.prototype.streamLogs = function(projectId, callback){
  modulus.io.success('Log streaming started...');
  scribe.project.streamLogs(projectId, userConfig.data.apiKey, callback);
};
