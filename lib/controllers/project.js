...
//-----------------------------------------------------------------------------
Project.prototype.deploy = function(projectId, dir, includeModules, nodeVersion, callback) {
      ...
      function(type, cb) {
        switch(type) {
          ...
          case Project.types.METEOR:
            ...
            projectController.demeteorize(dir, nodeVersion, cb);
            break;
        }
      },
...
Project.prototype.demeteorize = function(dir, nodeVersion, callback) {
  ...
  demeteorizer.convert(dir, out, nodeVersion, function(err) {
    if(err) {
      callback(err);
    }
    else {
