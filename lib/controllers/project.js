...
//-----------------------------------------------------------------------------
Project.prototype.deploy = function(projectId, dir, projectType, includeModules, nodeVersion, forceNpmInstall, callback) {
  ...
  async.waterfall([
      ...
      function(path, zipFile, cb) {
        projectController._deploy(projectId, zipFile, forceNpmInstall, function(err, domain) {
          fs.unlinkSync(zipFile);
...
//-----------------------------------------------------------------------------
Project.prototype._deploy = function(projectId, file, forceNpmInstall, callback) {
  ...
  client.upload(projectId, file, { forceNpmInstall: !!forceNpmInstall });
