module.exports = function (modulus) {
  ...
  modulus.program
    ...
    .action(function () {
      modulus.runCommand(
        modulus.commands.addons.getForProject,
  ...
  modulus.program
    ...
    .action(function (addon) {
      modulus.runCommand(
        modulus.commands.addons.provision,
        [modulus.program.projectName, addon],
        true
      );
    });
  ...
  modulus.program
    ...
    .action(function (addOnId) {
      modulus.runCommand(
        modulus.commands.addons.deprovision,
        [modulus.program.projectName, addOnId],
        true
      );
    });
