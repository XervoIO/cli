module.exports = function(modulus) {
  ...
  modulus.program
    ...
    .option('-o, --output [value]', 'Specifies the directory to download to. Prompts are skipped when specified');
  ...
  help.add('logs', function() {
    ...
    this.line('  options:'.input);
    this.line('    -p, --project-name    Name of the project to deploy. Prompts are skipped when specified.'.input);
    this.line('    -d, --directory       Flag that signals to download the logs instead of printing them.'.input);
    this.line('    -o, --output          Specifies the filepath to download to. Promps are skipped when specified.'.input);
    this.line('');
  ...
  modulus.program
    ...
    .on('--help', help.commands.logs, help.commands.logClear)
    .action(function(dir){
