module.exports = function(modulus) {
  ...
  help.add('deploy', function() {
    ...
    this.line('    -n, --node-version    Specifies the node version to use when deploying Meteor projects, if applicatable.');
    this.line('    -t, --project-type    Specifies type of application you are deploying. Overrides the auto-detection that occurs normally. Acceptable types are listed below.');
    this.line('      nodejs   A typical Node.js application.');
    this.line('      meteor   A Meteor application.');
  });
